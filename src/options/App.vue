    ...
    <div>
      <ul class="setting-list">
        ...
        <li>
          ...
          <p>
            tips：提醒不能保证购买或者卖出之后一定会涨或者跌，请根据自己实际情况处理。
          </p>
        </li>
        <li>
          <div class="list-title">
