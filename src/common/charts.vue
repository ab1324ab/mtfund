...
export default {
  ...
  data() {
    return {
      ...
      ma10day: null,
      ma20day: null,
      valuaDetails: "http://j4.dfcfw.com/charts/pic6/",
      detailsImg: ""
    };
  },
  watch: {},
  ...
  methods: {
    init() {
      ...
      //     this.chartEL, this.darkMode ? "dark" : "customed"
      // );
      // this.option = {
      //   tooltip: {
      //     trigger: "axis",
    ...
    getData() {
      // http://j4.dfcfw.com/charts/pic6/014605.png?v=20230731104453?v=0.726670903391401
      // let imgUrl = this.valuaDetails + this.fund.fundcode + ".png" + "?v=" + Math.random()
